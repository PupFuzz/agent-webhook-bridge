...
php artisan bridge:provision    # idempotent webhook subscription setup (--reconcile fixes drift; refuses a receiver URL this app would not route, --allow-unreachable-receiver overrides; refuses outright a receiver base bridge:check rejects as a URL)
