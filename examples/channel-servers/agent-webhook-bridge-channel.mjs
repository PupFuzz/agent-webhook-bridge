...
const TOOL_DEFINITIONS = [
  ...
  },
  {
    ...
    description:
      ...
      'shared one if your bridge is configured for it) — exactly what board_my_cards ' +
      'shows you. You do NOT have to have filed the card: taking work somebody else ' +
      'queued for you is the point. ' +
