...
| any | yes, and **PINNED** | **refused** — no write at all: the lifecycle move, the closed-unmerged archive and the create-race collapse's duplicate-archive are all withheld (DL-335, widened by DL-340, see below) |
