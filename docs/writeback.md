...
| | the thread's only card is ARCHIVED — a deliberate retire (DL-296); a `coord:reroute-archived` twin is exempt | `coord_card_archived_twin` | ✅ |
