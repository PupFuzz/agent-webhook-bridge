...
**Patch — governance-docs + dependency bumps only; zero runtime code change.** 6 substantive commits since v0.62.0 (PRs #336, #337, four dependabot merges #331–#334, plus a docs-only solo-orientation sync). **No migration, no new required `.env`, no receiver accept/reject change, no token-scope change; no `app/` file touched.**
