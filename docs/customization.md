...
- `app/Bridge/Handlers/` — shipped handlers (`log_intent`, `registry_append`, `channel_push`, `kanban_move_card`, `kanban_dependabot_card`, `kanban_block_reason`, `kanban_coord_card`, `kanban_coord_card_move`, `github_pr_correlation_comment`; `spawn_detached` opt-in)
