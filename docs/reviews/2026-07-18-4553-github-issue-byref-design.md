...
- **Label→lane is DEFERRED to the reconcile for v1 (R2 finding 4).** A single `coord_card_stage_id` cannot
  ...
  **[The fast-follow LANDED — card#6371 / DL-286, `coord_card_lane_stage_ids`. The deferral's premise was
