 ...
 * empties core shared by every comma-separated `BRIDGE_*` list in config/bridge.php
 * (`command grep -n CsvEnv config/bridge.php`), so that shape can't drift between them.
 *
