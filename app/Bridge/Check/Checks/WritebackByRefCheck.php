...
final class WritebackByRefCheck implements Check
{
    ...
    public function run(CheckContext $ctx): iterable
    {
        ...
        try {
            ...
            // The kanban RESPONSE BODY summary rides in on `RequestException`'s message —
            // see `WritebackBoardStateCheck`.
            yield Finding::unvalidated('writeback: could not probe by-ref reachability — '.UntrustedText::forOperator($e->getMessage()));
        }
    }
}
