...
enum NextStepState: string
{
     ...
     * `sudo` does not install), and a file a root-resolved run could not OPEN. The state
     * itself is still right on those arms — nothing was measured, and re-provisioning is
