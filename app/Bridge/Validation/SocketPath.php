...
/**
 * Format-only validator for the agent YAML's seat-side filesystem paths
 * (`channel.socket`, `channel.server_path` since DL-229, and
 * `idle_nudge.seat_record`): a non-empty
