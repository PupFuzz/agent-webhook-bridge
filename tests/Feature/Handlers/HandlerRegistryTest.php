...
class HandlerRegistryTest extends TestCase
{
    ...
    {
        $this->assertSame(
            ['channel_push', 'kanban_block_reason', 'kanban_dependabot_card', 'kanban_move_card', 'log_intent', 'registry_append'],
            (new HandlerRegistry)->known(),
        );
        $this->assertSame(
            ['channel_push', 'kanban_block_reason', 'kanban_dependabot_card', 'kanban_move_card', 'log_intent', 'registry_append', 'spawn_detached'],
