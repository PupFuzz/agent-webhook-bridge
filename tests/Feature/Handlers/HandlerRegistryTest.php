...
class HandlerRegistryTest extends TestCase
{
    ...
    {
        $this->assertSame(
            ['channel_push', 'github_pr_correlation_comment', 'kanban_block_reason', 'kanban_coord_card', 'kanban_coord_card_move', 'kanban_dependabot_card', 'kanban_move_card', 'kanban_promote_released', 'log_intent', 'registry_append'],
            (new HandlerRegistry)->known(),
        );
        $this->assertSame(
            ['channel_push', 'github_pr_correlation_comment', 'kanban_block_reason', 'kanban_coord_card', 'kanban_coord_card_move', 'kanban_dependabot_card', 'kanban_move_card', 'kanban_promote_released', 'log_intent', 'registry_append', 'spawn_detached'],
