...
class ExceptionMessageRedactionCensusTest extends TestCase
{
    ...
    private const TYPE_BOUNDS = [
        ...
        'App\Bridge\Exceptions\UnreadableSecretException' => 'a local secret-file read fault: an UnreadableFileException\'s text over the path this install configured, re-typed by TokenFile',
    ...
    private const RULINGS = [
        ...
        'Bridge/Writeback/ProtocolInvalidLabelDebt.php::read#1' => self::BINDING_EXCLUDES_REQUEST_EXCEPTION,
        ...
        'Console/Commands/Bridge/RelabelCommand.php::owedInScope#1' => self::BINDING_EXCLUDES_REQUEST_EXCEPTION,
        'Console/Commands/Bridge/RelabelCommand.php::owedInScope#2' => self::BINDING_EXCLUDES_REQUEST_EXCEPTION,
