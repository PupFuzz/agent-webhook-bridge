...
class BoardMyCardsTagReadTest extends TestCase
{
    ...
    public function test_a_call_without_tag_sends_the_same_requests_and_returns_the_same_keys_as_before(string $door): void
    {
        ...
        $this->assertSame(['id', 'name', 'stage', 'tags', 'assigned_user_id', 'dl_number', 'pr_number', 'pr_url', 'updated_at'], array_keys($default['cards_by_stage']['Backlog'][0]), 'the lane card gains no swimlane_id key');
