...
class BridgeCommandsTest extends TestCase
{
    ...
    public function test_check_reports_an_undeclared_channel_server_path_as_unvalidated(): void
    {
        ...
        // prints and accounts for all 39 registered checks, so that caveat is
        ...
        $this->assertStringContainsString('39 registered', $out);
        $this->assertStringContainsString('All 39 are accounted for', $out);
    }
