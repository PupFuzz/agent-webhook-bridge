...
final class SourceScan
{
     ...
     *
     * The call-site half of a census predicate, hoisted here at its second caller (canon #5)
     * so that a census answering "which classes call X" spells the recognition once.
